    ...
    <>
      <Navbar color="dark" expand="md" className="flex justify-between items-center w-full px-6 py-4 font-mono">
        <Nav navbar className="flex">
          ...
          <NavItem>
            <NavLink href="/addcustomer" className="text-white">Add Customer</NavLink>
          </NavItem>
          <NavItem>
          ...
          <NavItem>
            <NavLink href="/bookappointment" className="text-white">Book Appointments</NavLink>
          </NavItem>
        </Nav>
        <Nav navbar>
          <NavItem className="ml-auto">
            <NavLink href="/appointments" className="text-white">Home</NavLink>
          </NavItem>
        </Nav>
      </Navbar>
    </>
